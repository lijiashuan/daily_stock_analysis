...
import { Activity, BarChart3, Bell, BriefcaseBusiness, Home, LogOut, MessageSquareQuote, Search, Settings2, Wallet } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'simulation', labelKey: 'layout.nav.simulation', to: '/simulation', icon: Wallet },
  ...
  { key: 'operations', labelKey: 'layout.nav.operations', to: '/operations', icon: Activity },
