...
import { BarChart3, BriefcaseBusiness, Home, LogOut, MessageSquareQuote, Settings2, TrendingUp, ClipboardList } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'simulation', label: '模拟交易', to: '/simulation', icon: TrendingUp },
  { key: 'operation-dashboard', label: '操作指令', to: '/operation-dashboard', icon: ClipboardList },
