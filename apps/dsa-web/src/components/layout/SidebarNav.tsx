...
import { Activity, BarChart3, Bell, BriefcaseBusiness, Home, LogOut, MessageSquareQuote, Settings2, Wallet } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'simulation', label: '模拟', to: '/simulation', icon: Wallet },
  { key: 'backtest', label: '回测', to: '/backtest', icon: BarChart3 },
  { key: 'operations', label: '操作', to: '/operations', icon: Activity },
